...
class RetentionSocket(bd.BasePartObject):
    ...
    def floor_x_dim(self):
        return self._measurements.floor_x_dim

    @property
    def floor_y_dim(self):
        return self._measurements.floor_y_dim

    @property
    def floor_radius(self):
        return self._measurements.floor_radius

    @property
    def middle_low_x_dim(self):
        return self._measurements.middle_low_x_dim

    @property
    def middle_low_y_dim(self):
        return self._measurements.middle_low_y_dim

    @property
    def middle_low_radius(self):
        return self._measurements.middle_low_radius

    @property
    def middle_high_x_dim(self):
        return self._measurements.middle_high_x_dim

    @property
    def middle_high_y_dim(self):
        return self._measurements.middle_high_y_dim

    @property
    def middle_high_radius(self):
        return self._measurements.middle_high_radius

    @property
    def top_x_dim(self):
        return self._measurements.top_x_dim

    @property
    def top_y_dim(self):
        return self._measurements.top_y_dim

    @property
    def top_radius(self):
        return self._measurements.top_radius

    @property
    def bottom_chamfer_height(self):
        return self._measurements.bottom_chamfer_height

    @property
    def middle_chamfer_height(self):
        return self._measurements.middle_chamfer_height

    @property
    def top_chamfer_height(self):
        return self._measurements.top_chamfer_height

    def _get_part(self):
        floor = common.GetRoundedRect(
            self.floor_x_dim, self.floor_y_dim, self.floor_radius
        )
        ...
        if len(layers) <= 1:
            raise ValueError(
                "None of the layers high enough",
                f"({constants.RESOLUTION=})",
                f"{self.bottom_chamfer_height=}",
                f"{self.middle_chamfer_height=}",
                f"{self.top_chamfer_height=}"
            )

        return bd.loft(layers, ruled=True)
